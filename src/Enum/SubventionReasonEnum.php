...
enum SubventionReasonEnum: int
{
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::DOUBLE_SUBVENTION => 'Élève doublement subventionné',
            ...
            self::COURS_ORGANISE_INSUFFISANT => 'Cours organisé insuffisamment',
            self::REGISTRE_INCOMPLET => 'Registre incomplet',
            self::PAS_MUSIQUE_CHAMBRE => 'Pas de musique de chambre',
